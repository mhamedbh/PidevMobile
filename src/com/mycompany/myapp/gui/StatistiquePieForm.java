...
public class StatistiquePieForm extends BaseForm {
    ...
    private double nbr_organisation = 29;
   
    Form current;
BaseForm form;
        public StatistiquePieForm(Resources res) throws IOException  {
        ...
        addTab(swipe, res.getImage("org.jpg"), spacer1, "Bienvenue");
        ...
        RadioButton all = RadioButton.createToggle("Organisation", barGroup);
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AddOrganisationForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    public void createPieChartForm() {
        ...
        //chna3ml stat feedback par rapport l organisation 
        double total = nbr_feedback + nbr_organisation;
        
        //values
        double prcntFeed = (nbr_feedback *100)/total;
        
        double prcntRec = (nbr_organisation * 100)/total;
        ...
        String []messages = {
            "Statistique feedback % organisaions"
        };
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Organisation",prcntRec);
